...
func init() {
	AvailableCommands = append(AvailableCommands, cli.Command{
		...
		Subcommands: []cli.Command{{
			...
			Usage:     "Calls the constant method bondTokenAddress on the BondedECDSAKeepFactory contract.",
			ArgsUsage: "",
			Action:    becdsakfBondTokenAddress,
...
func becdsakfBondTokenAddress(c *cli.Context) error {
